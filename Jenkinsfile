pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                script {
                    app = docker.build("mohsin9055/react-app")
                    app.inside {
        ...
        stage('Push Docker Image') {
            ...
            steps {
                script {
                    docker.withRegistry('https://registry.hub.docker.com', 'mohsin9055') {
         ...
         stage('DeployToStaging') {
            ...
            steps {
                    script {
                        sh "docker pull mohsin9055/react-app:${env.BUILD_NUMBER}"
                        try {
                        ...
                        sh "docker run --restart always --name react-app -p 1233:80 -d mohsin9055/react-app:${env.BUILD_NUMBER}"
                    }
            }
        }
